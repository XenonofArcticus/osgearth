...
public class osgViewer extends Activity implements View.OnTouchListener, View.OnKeyListener
{
    ...
    @Override protected void onCreate(Bundle icicle)
    {
		...
		uiSceneNameSpinner = (Spinner) findViewById(R.id.uiSceneNameSpinner);

		// Create an ArrayAdapter using the string array and a default spinner layout
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
				R.array.uiSceneNameArray, R.id.uiSceneNameSpinner);
		// Specify the layout to use when the list of choices appears
		adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		// Apply the adapter to the spinner
		uiSceneNameSpinner.setAdapter(adapter);		
    }
